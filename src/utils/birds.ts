const birdsData = [
  {
    ...
    category: 'Warm up',
    description:
      'The raven is a large bird. The body length reaches 70 centimeters, the wingspan is up to one and a half meters. Ravens inhabit the vicinity of the Tower. There is a belief in England that the day the black crows fly away from the Tower, the monarchy will collapse.',
  ...
  },
  {
    ...
    category: 'Warm up',
    description:
      'The sounds made by the crane are similar to the sonorous "kur-ly - kur-ly". Cranes most often sing in a duet - one bird begins the song with the syllable "kur", and the second picks up "ly". If a bird sings alone, then it only makes the sound "chicken".',
  ...
  },
  {
    ...
    category: 'Warm up',
    description:
      'The cuckoo was named so because of the peculiarities of its songs. The voiced “cuckoo” cannot be confused with any other bird. Cuckoos do not build nests, their offspring are raised by other species of birds, to which cuckoos toss their eggs.',
  ...
  },
  {
    ...
    category: 'Passerines',
    description:
      'In the chirping of tits, more than 40 different sound combinations are distinguished. They sing almost all year round, fading a little only in winter. Tits are real orderlies of the forest. One pair of tits during the nesting period protects dozens of trees from pests.',
  ...
  },
  {
    ...
    category: 'Passerines',
    description:
      'Sparrows are the most famous and recognizable birds. They are easily recognizable by their colorful plumage and perky chirping. Sparrows are a synatropic species - they settle close to human habitation.',
  ...
  },
  {
    ...
    category: 'Passerines',
    description:
      'Rooks are very smart and quick-witted birds. With the help of a beak, they create and use the simplest tools. Rooks have a developed reflex to the sounds of a tractor. Hearing the “rattle”, they fly towards the sound – the tractor is plowing the ground, which means that there is a lot of food in this place.',
  ...
  },
  {
    ...
    category: 'Passerines',
    description:
      'Song Thrush is the best singer of the sparrows. The song consists only of beautiful sonorous whistles and short trills. Most often it can be heard in the morning and evening. Thrushes sing during the entire nesting period.',
  ...
  },
  {
    ...
    category: 'Passerines',
    description:
      'When a jay is worried, the tuft on her head is ruffled. The bird tries to create a frightening sight. Jays are able to imitate the voices of other birds, animals and the sounds that humans create. For the winter they store large stocks of acorns and nuts.',
  ...
  },
  {
    ...
    category: 'Forest',
    description:
      'There are 450 species of finches in the wild. In winter, finches lead a flocking lifestyle. Sometimes sparrows can be seen in their families. Finches sing in the spring, with the onset of the mating season. Their singing is a flooded multi-minute roulades.',
  ...
  },
  {
    ...
    category: 'Forest',
    description:
      'Crossbill are called "Christmas" birds. Under natural conditions, they give birth in winter - in January. These birds insulate their nests with moss and animal hair, so the chicks are not cold. In search of cones crossbills can fly 3500 km from the nest.',
  ...
  },
  {
    ...
    category: 'Forest',
    description:
      'The turtle dove lives in mixed and broad-leaved forests, as well as in city parks and towns. Birds often choose places of life next to humans and easily get used to people. Due to the melodic pleasant singing of turtle doves, they are often bred at home.',
  ...
  },
  {
    ...
    category: 'Forest',
    description:
      'Hoopoes prefer to live in open landscapes with individual trees or groves. The most convenient for the bird are the forest-steppe and savannah. A hoopoe can choose places of residence next to a person: pastures, vineyards, orchards.',
  ...
  },
  {
    ...
    category: 'Forest',
    description:
      'The swift can be seen in almost every corner of the planet. They live both in forest areas and in open areas. Swifts live in large flocks. Large colonies of these birds can be seen in towns or on coastal cliffs.',
  ...
  },
  {
    ...
    category: 'Predatory',
    description: `The falcon's Latin name, Falco, comes from the word 'sickle' because of the crescent-shaped wings. Long and wide wings allow the falcon to rise high into the sky and soar freely. The falcon's flight speed reaches 280-320 kilometers per hour.`,
  ...
  },
  {
    ...
    species: 'Pelecanus',
    category: 'Marine',
    description: `Pelicans are inhabitants of the seas and rivers. They walk awkwardly, but fly and swim well. They feed mainly on fish, arrange collective hunts - lined up in a semicircle, they flap their wings and beaks on the water and force out the frightened fish in shallow water.`,
  ...
  },
  {
    ...
    category: 'Marine',
    description: `The male emperor penguin reaches a height of 130 cm and can weigh up to 50 kg. Of all modern penguins, this species is the largest. The penguin's diet consists of fish, squid and krill. Birds hunt in large groups in the ocean.`,
